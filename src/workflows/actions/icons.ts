...
export function getAbsoluteIconPath(relativeIconPath: string): {
  ...
  return {
    light: vscode.Uri.joinPath(_context.extensionUri, "images", "light", relativeIconPath),
    dark: vscode.Uri.joinPath(_context.extensionUri, "images", "dark", relativeIconPath)
  };
}
