...
export function createTerminal(context: vscode.ExtensionContext) {
	...
	context.subscriptions.push(vscode.commands.registerCommand('bevara-compiler.createTerminal', () => {
		let line = '';
		const pty = {
	...
	context.subscriptions.push(vscode.commands.registerCommand('bevara-compiler.clear', () => {
